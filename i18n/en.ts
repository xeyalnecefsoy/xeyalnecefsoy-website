...
export const en = {
  ...
  home: {
    ...
    aboutDesc: 'I believe in building products that solve real problems for real people. Every platform I create is driven by a mission — to empower Azerbaijani-speaking communities with modern digital tools and everyday clarity. My work is defined by impact, not just code.',
